  ...
  const generateWithGemini = async () => {
    ...
    try {
      ...
      const prompt = contentType === 'quote'
        ? "Provide an inspirational quote about life, success, or personal growth. Provide both the quote and attribute it to the wise person. Respond in JSON format with 'text' and 'author' fields."
