  ...
  const generateWithGemini = async () => {
    ...
    try {
      ...
      const prompt = contentType === 'quote'
        ? "Provide an inspirational quote about life, success, womanhood, or personal growth. Provide both the quote and attribute it to the wise person. Respond in JSON format with 'text' and 'author' fields."
        : "Provide a short inspirational poem (4-8 lines) about hope, dreams, or overcoming challenges. Provide the poem and attribute it to a the poet. Respond in JSON format with 'text' and 'author' fields.";
